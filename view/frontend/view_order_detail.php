<div class="col-md-10 col-xs-offset-1">
	...
	<?php 
		...
		{
	 ?>
		<a href="index.php?controller=order_detail&act=cancel&order_id=<?php echo $order_id; ?>" class="btn btn-danger">Hủy Đơn Hàng</a>&nbsp;
		<?php } ?>
		<a href="order.html" class="btn btn-primary">Xác Nhận</a>&nbsp;
	</div>
	<?php 
