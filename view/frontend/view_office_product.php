<div class="office-machine" style="margin-top: 20px;">
	<b style="color: #36ae8f;margin-left: 10px;">MÁY VĂN PHÒNG</b>
	<a href="product/category/4/may-tinh" style="margin-left: 700px;color: #9bc07d;">Xem thêm >></a>
	<table cellspacing="30px;" style="border-top: 1px solid #dddddd;">
		<tr>
			<?php $product = model::get_all("select * from tbl_product where fk_category_product_id=4 limit 0,4");
